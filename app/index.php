<?php
    ...
    $head = new Template("lib/themes/".$theme."/template/header.tpl.php");
    $page = new Template("lib/themes/".$theme."/template/main.tpl.php");
    $navbar = new Template("lib/themes/".$theme."/template/navbar.tpl.php");
    ...
    $content = new Template("lib/themes/".$theme."/template/pages/".$contentLink.".tpl.php");
    $footer = new Template("lib/themes/".$theme."/template/footer.tpl.php");
